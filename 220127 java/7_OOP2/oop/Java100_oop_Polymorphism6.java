...
public class Java100_oop_Polymorphism6 {
	public static void main(String[] args) {
		...
		Test[] t1 = {new Home(), new Delete(), new End()};
		
		for(int i = 0; i < t1.length; i++){
			t1[i].qwer();
		}
		
		Test[] t2 = {new Delete(), new Home(), new End()};
		System.out.println();
		for(Test obj : t2){
			obj.qwer();
		}
...
class Home extends Test{
	void qwer(){
		System.out.println("Test Home");
	}
}

class End extends Test{
	void qwer(){
		System.out.println("Test End");
	}
}

class Delete extends Test{
	void qwer(){
